 ...
 *
 * @param <K> Type of the key that is used to store and lookup entries. Keys should be kept simple
 *            as they might be stored in memory. A Key relies on correct implementations of HashCode
 *            and Equals.
 * @param <V> Type of entries that can be stored and retrieved from the cache.
 * @author Philip Washington Sorst <philip@sorst.net>
 */
public interface Cache<K, V>
{
    long UNLIMITED_IDLE_TIME = 0;
     ...
     * @return The entry that has been stored in the cache. It is save to alter this as
     * implementations as implementations make sure that this is always (at least) a copy.
     * @throws CacheException Thrown on any errors encountered, supposed to include the stacktrace (if any).
     */
     ...
     *
     * @param key The unique key under which the entry was stored.
     ...
     *
     * @param key The key under which the entry was stored.
     ...
     *
     * @param defaultTTL The default time to live for a cache entry in milliseconds.
     */
     ...
     *
     * @throws CacheException Thrown if the cleanup failed.
     */
